...
public class ToolsFileUtils2 {
	public static void main(String[] args) throws IOException {

			
		//FileUtils读取文件--------------------
		String filename = "20190930.txt";
		File file = new File("D:\\lntraf\\"+filename);
		try {
			...
			for(String msg:lines){
				i++;
				//if(msg.length()!=62){
					String xxx = "第"+i+"行："+msg;
					System.out.println(xxx);
					
					FileUtils.write(new File("D:\\lntraf\\test"), xxx+"\r\n","GBK",true); 
				//}
			}
				//System.out.println();
		} catch (IOException e) {
